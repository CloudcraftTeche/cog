...
import { formatFullDate } from "@/utils/student/announcement-utils";
import { X, Pin, Calendar, Users, Sparkles } from "lucide-react";
            ...
            <div className="mt-6 p-5 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border-2 border-purple-100">
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <div>
                  ...
                  <span className="text-purple-700 font-medium">All Grades</span>
                </div>
              </div>
            </div>
          )}
