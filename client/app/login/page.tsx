...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div
        className="lg:flex-1 relative bg-cover bg-center bg-no-repeat min-h-screen lg:min-h-auto"
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen lg:min-h-auto p-4 sm:p-6 lg:p-8">
