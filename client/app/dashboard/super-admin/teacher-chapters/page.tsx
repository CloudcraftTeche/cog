...
export default function SuperAdminTeacherChaptersPage() {
  ...
  const handleViewStatistics = (chapterId: string) => {
    router.push(`/dashboard/super-admin/teacher-chapters/${chapterId}/statistics`);
  };
  const handleEdit = (chapterId: string) => {
    router.push(`/dashboard/super-admin/teacher-chapters/edit/${chapterId}`);
  };
  const gradeColors = [
        ...
        <div className="mb-8 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-8 text-white shadow-2xl">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <Button
              ...
              onClick={() =>
                router.push("/dashboard/super-admin/teacher-chapters/upload")
              }
              size="lg"
            >
