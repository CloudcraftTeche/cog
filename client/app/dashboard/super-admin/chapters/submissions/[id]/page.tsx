...
export default function ChapterSubmissionsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (chapterData.studentProgress && chapterData.studentProgress.length > 0) {
          ...
          <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 rounded-3xl p-8 text-white shadow-2xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-purple-100 text-lg mt-1">Student Submissions</p>
              </div>
            </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Avatar className="h-12 w-12 border-2 border-white shadow-lg">
                        <AvatarImage src={studentSubmission.studentId.profilePictureUrl} />
