...
import { CheckCircle, Plus, Trash2, Upload, Video, FileUp, Sparkles, Check, BookOpen } from "lucide-react";
...
export default function UploadTeacherContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post(`/teacher-chapter`, payload, {
        headers: { "Content-Type": "application/json" },
      });
      setSuccess(true);
      toast.success("Content Uploaded!", {
        description: "Your training content has been successfully uploaded.",
      });
      setTimeout(() => {
      ...
      <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white py-8 mb-8 rounded-3xl">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-3xl font-bold">Upload Teacher Training Content</h1>
          </div>
          <p className="text-indigo-100 text-lg">Create professional development materials for teachers</p>
        </div>
      </div>
        ...
        {success && (
          <Alert className="mb-8 border-emerald-200 bg-gradient-to-r from-emerald-50 to-teal-50 shadow-lg rounded-2xl">
            ...
            <AlertDescription className="text-emerald-800 font-medium">
              Content uploaded successfully! Teachers can now access this material.
            </AlertDescription>
          </Alert>
        )}
            ...
            <Card className="shadow-2xl border-0 bg-white rounded-3xl overflow-hidden">
              ...
              <CardContent className="space-y-6 p-8">
                <div className="flex md:flex-row flex-col flex-wrap gap-6 md:items-center justify-between">
                  ...
                  <div className="space-y-3">
                    <Label htmlFor="grades" className="text-sm font-semibold text-slate-700 flex items-center">
                  ...
                  <div className="space-y-3">
                    ...
                    <Select onValueChange={(val) => setSelectedUnit(val)} value={selectedUnit}>
                      <SelectTrigger
                        id="unit"
                ...
                <div className="space-y-3">
                  ...
                  <Textarea
                    id="description"
                    placeholder="Describe what teachers will learn from this content..."
                    value={description}
              ...
              <Card className="shadow-2xl border-0 bg-white rounded-3xl overflow-hidden">
                ...
                <CardContent className="space-y-6 p-8">
                  <div className="space-y-4">
                    <div className="space-y-3">
                      <Textarea
                        placeholder="Enter or paste the training content here..."
                        value={textContent}
                        onChange={(e) => setTextContent(e.target.value)}
                        rows={12}
                        className="border-2 border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 rounded-xl resize-none text-sm leading-relaxed min-h-[400px] transition-all duration-300"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-xs text-emerald-600 font-medium">Ready for teachers</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <CardHeader className="pb-4 bg-gradient-to-br from-orange-50 to-red-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-slate-600 text-base">
                      Add optional quiz questions to test understanding
                    </CardDescription>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
              ...
              <CardContent className="space-y-6 p-8">
                ...
                {!includeQuiz && (
                  <div className="text-center py-12 bg-slate-50 rounded-xl border-2 border-dashed border-slate-300">
                    ...
                    <p className="text-slate-600 font-medium mb-2">No quiz included</p>
                    <p className="text-slate-500 text-sm">
                      Enable "Include Quiz" to add assessment questions
                    </p>
                  </div>
                )}
              </CardContent>
