...
export default function TeacherEditStudentPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        const [teacherResponse, studentResponse] = await Promise.all([
          api.get("/auth/me"),
          api.get(`/students/teacher/students/${studentId}`),
        ]);
        const teacherGradeId = teacherResponse.data.data.gradeId;
        setTeacherGrade({
          _id: teacherGradeId._id,
          grade: teacherGradeId.grade,
        });
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await api.put(`/students/teacher/students/${studentId}`, formDataObj, {
        ...
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <p className="text-indigo-100 text-lg">
              Update student information for {teacherGrade.grade}
            </p>
          </div>
        </div>
      </div>
