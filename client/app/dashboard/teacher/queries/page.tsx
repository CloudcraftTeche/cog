...
const TeacherQueryPage: React.FC = () => {
  ...
  const fetchStatistics = async () => {
    try {
      const { data } = await api.get<ApiResponse<QueryStatistics>>(
        "/queries/statistics/overview",
      );
      if (data.success) {
  ...
  const handleUpdateStatus = async (
    ...
    try {
      const { data } = await api.patch<ApiResponse<Query>>(
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 mb-1 font-semibold">
                    Total Queries
                  </p>
            ...
            <div className="bg-gradient-to-br from-amber-500 to-yellow-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-amber-100 mb-1 font-semibold">
                    In Progress
                  </p>
                  <p className="text-4xl font-bold">
            ...
            <div className="bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-emerald-100 mb-1 font-semibold">
                    Avg Rating
                  </p>
                  <p className="text-4xl font-bold">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-teal-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <button
              onClick={() =>
                setFilters({ status: "", priority: "", queryType: "" })
              }
          ...
          {loading ? (
            ...
            queries.map((query) => {
              ...
              return (
                <div
                  key={query._id}
                  className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl transition-all duration-300 border border-teal-100 transform hover:-translate-y-1"
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3 flex-wrap">
                        ...
                        <span
                          className={`px-4 py-2 rounded-full text-sm font-bold text-white bg-gradient-to-r ${priorityGradient}`}
                        >
                      ...
                      <div className="flex items-center gap-6 text-sm flex-wrap">
                        <span className="flex items-center gap-2 bg-teal-50 px-3 py-2 rounded-lg">
                          ...
                          <span className="text-teal-900 font-semibold">
                            {query.from.name} (Roll: {query.from.rollNumber})
                          </span>
                        </span>
                  ...
                  <div className="flex gap-3 mt-6 pt-6 border-t-2 border-teal-100 flex-wrap">
                    {query.status === "open" && (
                      <button
                        onClick={() =>
                          handleUpdateStatus(query._id, "in_progress")
                        }
                    ...
                    {(query.status === "in_progress" ||
                      ...
                      <>
                        <button
                          onClick={() =>
                            handleUpdateStatus(query._id, "resolved")
                          }
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      {(() => {
                        ...
                        const priorityGradient = getPriorityColor(
                  ...
                  <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6 border-2 border-teal-100">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="font-bold text-gray-900 text-lg">
                        {selectedQuery.from.name} (Roll:{" "}
                        {selectedQuery.from.rollNumber})
                      </span>
