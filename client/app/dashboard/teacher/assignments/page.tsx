...
export default function TeacherAssignmentsPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const gradeData = gradeRes.data.data.gradeId;
      setGrade(gradeData);
      ...
      setTotalPages(assignmentsRes.data.pagination?.totalPages || 1);
    } catch (error: any) {
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-8 text-white shadow-2xl mb-6">
            <div className="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
              ...
              <Button
                ...
                onClick={() =>
                  router.push("/dashboard/teacher/assignments/create")
                }
                size="lg"
              >
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 text-lg">
              You haven't been assigned to a grade yet. Please contact your
              administrator.
            </p>
          </div>
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 text-lg mb-6">
              {searchTerm
                ...
                : "Create your first assignment for this grade"}
            </p>
            {!searchTerm && (
              <Button
                onClick={() =>
