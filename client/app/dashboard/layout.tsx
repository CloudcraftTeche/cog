    ...
    <div className="flex h-screen w-full overflow-hidden bg-gray-50">
      <div
        className={cn(
          ...
          "lg:translate-x-0 lg:static lg:inset-0 lg:w-80 lg:z-0",
        )}
      >
          ...
          <div className="flex items-center justify-between px-3 sm:px-4 lg:px-6 h-14 sm:h-16">
            <div className="flex items-center gap-2 sm:gap-4 min-w-0">
              ...
              <div className="hidden sm:block min-w-0">
                ...
                <p className="text-xs text-gray-500 font-medium truncate">Welcome back, {user?.name}</p>
              </div>
            </div>
                  ...
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <Avatar className="h-9 w-9 sm:h-10 sm:w-10 ring-2 ring-orange-200">
                        <AvatarImage src={user?.avatar || "https://png.pngtree.com/png-vector/20210604/ourmid/pngtree-gray-network-placeholder-png-image_3416659.jpg"} alt={user?.name} />
                        <AvatarFallback
                          className={cn("text-white font-semibold text-sm", getRoleColor(user?.role || ""))}
                        >
