...
export const createOrUpdateAttendance = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { studentId, status, gradeId, remarks } = req.body;
...
export const getTodayAttendance = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const today = new Date();
    today.setHours(0, 0, 0, 0);
    const tomorrow = new Date(today.getTime() + 86400000);
...
export const getAttendanceByGrade = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getAttendanceStats = async (_req: AuthenticatedRequest, res: Response) => {
  try {
    const today = new Date();
    today.setHours(0, 0, 0, 0);
    const tomorrow = new Date(today.getTime() + 86400000);
...
export const getTeacherStats = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getAttendanceHeatmap = async (_req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getTeacherHeatmap = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { teacherId } = req.params;
    const teacher = await Teacher.findById(teacherId);
    if (!teacher) {
...
export const exportAttendance = async (req: AuthenticatedRequest, res: Response) => {
  try {
