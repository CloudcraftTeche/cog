...
export const getTeacherQueries = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const getAdminMyQueries = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const getAdminDepartmentQueries = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const assignQueryToMe = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
